...
var Pagina = {
	...
	interface:{
		...
		abrirModalCor(id){
			...
			$("#cor-modal a").click(async (b)=>{
				const cor = b.target.classList[1];
		...
		tema:{
			...
			backgroundElements:["body", ".sidenav", ".sidenav .card",".sidenav .collapsible div", "#criar-modal", "#criar-modal .modal-footer","#deletar-modal","#deletar-modal .modal-footer", "#cor-modal"],
			textElements:[".sem-poemas" , "#Tela_Busca #apresentacao", ".input-field input", ".sidenav", "#criar-modal","#deletar-modal", "textarea","#cor-modal"],
			async lerTema(){
